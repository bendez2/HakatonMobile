...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Uno.UI.Controls.Legacy.HorizontalListView, Uno.UI", HorizontalListView.class, __md_methods);
	}


	public HorizontalListView (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == HorizontalListView.class)
			mono.android.TypeManager.Activate ("Uno.UI.Controls.Legacy.HorizontalListView, Uno.UI", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}


	public HorizontalListView (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == HorizontalListView.class)
			mono.android.TypeManager.Activate ("Uno.UI.Controls.Legacy.HorizontalListView, Uno.UI", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}
