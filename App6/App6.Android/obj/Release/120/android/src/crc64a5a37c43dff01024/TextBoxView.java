...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Windows.UI.Xaml.Controls.TextBoxView, Uno.UI", TextBoxView.class, __md_methods);
	}


	public TextBoxView (android.content.Context p0)
	{
		super (p0);
		if (getClass () == TextBoxView.class)
			mono.android.TypeManager.Activate ("Windows.UI.Xaml.Controls.TextBoxView, Uno.UI", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}


	public TextBoxView (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == TextBoxView.class)
			mono.android.TypeManager.Activate ("Windows.UI.Xaml.Controls.TextBoxView, Uno.UI", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}


	public TextBoxView (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == TextBoxView.class)
			mono.android.TypeManager.Activate ("Windows.UI.Xaml.Controls.TextBoxView, Uno.UI", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}
