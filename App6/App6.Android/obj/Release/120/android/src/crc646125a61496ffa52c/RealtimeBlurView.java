...
/** @hide */
	...
	public RealtimeBlurView (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == RealtimeBlurView.class)
			mono.android.TypeManager.Activate ("Uno.UI.Xaml.Media.RealtimeBlurView, Uno.UI", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}
